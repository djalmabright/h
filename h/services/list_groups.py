...
class ListGroupsService(object):
    ...
    def associated_groups(self, authority, user=None):
        """
        Return a list of groups relevant to this session/profile (i.e. user).

        Return a list of groups filtered on user and authority that the user
        belongs to or is associated with (user is a creator/moderator/member).
        ...
        world_readable_groups = [
            group for group in self._readable_by_world_groups(user, authority)
